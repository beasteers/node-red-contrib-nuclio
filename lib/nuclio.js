...
const { debounced, parseIntFallback, asString, nestedAssign, retryBackoff } = require('./util');
...
const TRANSIENT_ERR_CODES = new Set(['ECONNREFUSED', 'ECONNRESET', 'ECONNABORTED', 'ETIMEDOUT', 'ENOTFOUND', 'EAI_AGAIN']);
const TRANSIENT_HTTP_STATUSES = new Set([429, 502, 503, 504]);
const isTransient = (err) => TRANSIENT_ERR_CODES.has(err?.code) || TRANSIENT_HTTP_STATUSES.has(err?.response?.status);
