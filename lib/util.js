...
// Node-RED setting resolution: node config (literal or env-typed) -> process
// environment -> built-in default. Keeping this here lets each node entrypoint
// use the same fallback semantics.
const numSetting = (RED, node, config, field, envVar, fallback) => {
