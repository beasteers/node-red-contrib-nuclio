...
async function deployFunctionConfig(node, {
    ...
    if (!foundProject) {
        ...
        try {
            // Any 2xx counts - axios already rejects non-2xx responses. A
            // concurrent deploy may create the project after our list request;
            // Nuclio reports that harmless race as HTTP 409.
