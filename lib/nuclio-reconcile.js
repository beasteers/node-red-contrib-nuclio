...
// not the default response to an unhealthy observation.
...
const reconcileStep = async (node) => {
    ...
    try {
        ...
        if (state === 'unhealthy') {
            ...
            // this observational by default; Node-RED can be configured as an
            // optional recovery actuator when that policy is wanted.
